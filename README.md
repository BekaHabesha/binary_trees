...
| **25** | **BST<br>-<br>Insert** | [**111-bst_insert.c**](./111-bst_insert.c) | [**bst_t *bst_insert(bst_t **tree, int value);**](./111-bst_insert.c) |
...
| **31** | **AVL<br>-<br>Insert** | [**121-avl_insert.c**](./121-avl_insert.c) | [**avl_t *avl_insert(avl_t **tree, int value);**](./121-avl_insert.c) |
...
| **37** | **Heap<br>-<br>Insert** | [**131-heap_insert.c**](./131-heap_insert.c) | [**heap_t *heap_insert(heap_t **root, int value);**](./131-heap_insert.c) |
...
| **39** | **Heap<br>-<br>Extract** | [**133-heap_extract.c**](./133-heap_extract.c) | [**int heap_extract(heap_t **root);**](./133-heap_extract.c) |
